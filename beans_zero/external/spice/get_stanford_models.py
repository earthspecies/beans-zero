...
def print_progress(transferred_blocks: int, block_size: int, total_size: int) -> None:
...
def get_stanford_models() -> None:
    ...
    if not os.path.exists(jar_name):
        ...
        zip_file, _ = urlretrieve(url, reporthook=print_progress)
        print()
